  ...
  return (
    <div className={`pt-8 px-6 shadow-md transition-all duration-300 ${marginLeft} ${marginTop}`}>
      ...
      <div className="h-20 bg-[#637D9B80] flex justify-between items-center">
        <h1 className="text-xl pl-4 text-white font-semibold">Course List</h1>
        ...
        <table className="min-w-full table-auto border-collapse">
          <thead>
            <tr>
              ...
              <th className="px-2 py-2">Cours Name</th>
          ...
          <tbody>
            ...
            <tr className="text-center border-t">
              ...
              <td className="px-4 py-2">Rs.11,256</td>
              <td className="px-4 py-5 flex justify-center">
                <Link to='/edit_course_list'>
                <EditIcon className=" cursor-pointer mx-2" />
                </Link>
                <Link>
