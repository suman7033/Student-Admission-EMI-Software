  ...
  return (
    <div className={`pt-8 px-6 transition-all duration-300 ${marginLeft} ${marginTop}`}>
      ...
      <div className="h-20 bg-[#637D9B80] flex justify-between items-center">
        <h1 className="text-xl pl-4 text-white font-semibold">City List</h1>
        ...
        <Link to="/add_city_list">
        <button className="mr-5 bg-[#637D9B] text-white px-4 py-2 rounded-md">Add City</button>
        </Link>
      </div>
        ...
        <table className="min-w-full table-auto border-collapse">
          <thead>
            <tr>
              ...
              <th className="px-2 py-2">Branch Name</th>
