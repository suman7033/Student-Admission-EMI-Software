    ...
    <div className={`p-8 transition-all duration-300 ${marginLeft} ${marginTop}`}>
      <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="flex flex-col">
            <label className="font-semibold pb-2">Branch Name*</label>
            <input type="text" placeholder="Enter Branch Name" className="w-52 border rounded-lg p-2" />
          </div>
      </div>
